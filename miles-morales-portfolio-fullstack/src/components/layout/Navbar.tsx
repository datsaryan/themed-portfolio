        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="relative">
            <button
              ...
              title={audioState.isPlaying ? 'Pause Sunflower (Miles Morales BGM)' : 'Play Sunflower (Post Malone & Swae Lee)'}
            ...
            >
              ...
              <div className="hidden lg:flex items-center gap-1.5 text-left">
                <span className="font-bold text-graffiti-yellow">SUNFLOWER</span>
                <span className="text-[10px] text-subtext/80 hidden xl:inline">// POST MALONE</span>
              </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="bg-surface/90 border border-spider/50 p-3 my-1 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="font-mono text-xs font-bold text-white">Sunflower</div>
                  <div className="font-mono text-[10px] text-subtext">Post Malone & Swae Lee</div>
                </div>
              </div>
              <button
                onClick={() => sound.toggleSong()}
